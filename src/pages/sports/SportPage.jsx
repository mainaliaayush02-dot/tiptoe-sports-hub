...
const DEFAULT_SPORTS = {
  ...
  'cricket': {
    ...
    features: [
      ...
      'Experienced cricket coaching staff',
      'Open play sessions & match bookings',
      'Youth cricket development program',
      'Equipment rental & retail available',
    ],
    facilities: [
      'Full-size cricket ground',
      'Professional batting nets (4 lanes)',
    ...
    pricing: [
      { plan: 'Ground Hire',       age: 'Per session', price: 'NPR 3,000/session', desc: 'Full ground booking (2 hrs)' },
      { plan: 'Net Practice',      age: 'Per hour',    price: 'NPR 800/hr',        desc: 'Batting nets with equipment' },
      { plan: 'Coaching Program',  age: 'All Ages',    price: 'NPR 4,000/month',   desc: 'Coached sessions, skill tracking' },
