...
const SEED_SCHEDULE = [
  { day: 'Monday',    startTime: '05:00', endTime: '06:30', sport: 'Football', ageGroup: 'Age 16-18', venue: 'Tarakeshwar Ground', coachName: 'Gaurav Basnet' },
  { day: 'Monday',    startTime: '15:00', endTime: '17:00', sport: 'Football', ageGroup: 'Age 4-10',  venue: 'Tarakeshwar Ground', coachName: 'Gaurav Basnet' },
  { day: 'Monday',    startTime: '17:00', endTime: '19:00', sport: 'Futsal',   ageGroup: 'All Ages',  venue: 'Futsal Arena',      coachName: 'Gaurav Basnet' },
  { day: 'Tuesday',   startTime: '05:00', endTime: '07:00', sport: 'Football', ageGroup: 'Age 16-18', venue: 'Tarakeshwar Ground', coachName: 'Gaurav Basnet' },
  { day: 'Tuesday',   startTime: '15:00', endTime: '17:00', sport: 'Football', ageGroup: 'Age 11-15', venue: 'Tarakeshwar Ground', coachName: 'Gaurav Basnet' },
  { day: 'Wednesday', startTime: '05:00', endTime: '06:30', sport: 'Football', ageGroup: 'Age 16-18', venue: 'Tarakeshwar Ground', coachName: 'Gaurav Basnet' },
  { day: 'Wednesday', startTime: '15:00', endTime: '17:00', sport: 'Football', ageGroup: 'Age 4-10',  venue: 'Tarakeshwar Ground', coachName: 'Gaurav Basnet' },
  { day: 'Thursday',  startTime: '05:00', endTime: '07:00', sport: 'Football', ageGroup: 'Age 16-18', venue: 'Tarakeshwar Ground', coachName: 'Gaurav Basnet' },
  { day: 'Thursday',  startTime: '15:00', endTime: '17:00', sport: 'Futsal',   ageGroup: 'All Ages',  venue: 'Futsal Arena',      coachName: 'Gaurav Basnet' },
  { day: 'Friday',    startTime: '05:00', endTime: '06:30', sport: 'Football', ageGroup: 'Age 16-18', venue: 'Tarakeshwar Ground', coachName: 'Gaurav Basnet' },
  { day: 'Friday',    startTime: '15:00', endTime: '17:00', sport: 'Football', ageGroup: 'Age 11-15', venue: 'Tarakeshwar Ground', coachName: 'Gaurav Basnet' },
  { day: 'Saturday',  startTime: '06:00', endTime: '08:30', sport: 'Football', ageGroup: 'Age 16-18', venue: 'Tarakeshwar Ground', coachName: 'Gaurav Basnet' },
  { day: 'Saturday',  startTime: '09:00', endTime: '11:00', sport: 'Football', ageGroup: 'Age 11-15', venue: 'Tarakeshwar Ground', coachName: 'Gaurav Basnet' },
  { day: 'Saturday',  startTime: '11:00', endTime: '13:00', sport: 'Football', ageGroup: 'Age 4-10',  venue: 'Tarakeshwar Ground', coachName: 'Gaurav Basnet' },
]

const SEED_SPORTS = [
  { name: 'Football & Futsal', slug: 'football-futsal', emoji: '⚽', tagline: "Nepal's Premier Football & Futsal Academy", description: "Tiptoe Sports Hub is Nepal's #1 private football and futsal academy, delivering world-class coaching to 370+ students daily in Tarakeshwar, Kathmandu. Structured programs for ages 4-18 with international exposure to Thailand.", facilities: "Full-size outdoor football field\nIndoor futsal court\nChanging rooms & showers\nEquipment room & kit storage\nCoaching video analysis setup", pricing: "Football Foundation (Age 4-10) - NPR 2,500/month\nYouth Development (Age 11-15) - NPR 3,000/month\nElite Performance (Age 16-18) - NPR 3,500/month\nFutsal Academy (All Ages) - NPR 2,800/month\nGirls Football (Age 8-18) - NPR 2,500/month", schedule: 'Mon-Fri: 6AM-8AM & 3PM-7PM | Sat-Sun: 7AM-12PM', seoTitle: 'Football & Futsal Academy in Kathmandu | Tiptoe Sports Hub', seoDescription: "Nepal's #1 football and futsal academy in Tarakeshwar, Kathmandu. Programs for ages 4-18, professional coaches, and international exposure to Thailand.", color: '#06145F', active: true, order: 1 },
  { name: 'Basketball', slug: 'basketball', emoji: '🏀', tagline: 'Premium Courts & Professional Coaching', description: 'Experience premium basketball training and open play at Tiptoe Sports Hub. Professional-grade courts and coaching staff provide the perfect environment for players of all skill levels.', facilities: "Full-size basketball court\nScoreboard & timing system\nSpectator seating\nLocker rooms with showers\nBall & equipment rental", pricing: "Court Hire - NPR 1,500/hr\nMonthly Membership - NPR 4,000/month\nCoaching Program - NPR 3,500/month\nTeam Package - NPR 6,000/month", schedule: 'Daily: 6AM-10PM | Coached sessions: Tue, Thu, Sat 5PM-7PM', seoTitle: 'Basketball Courts & Training in Kathmandu | Tiptoe Sports Hub', seoDescription: 'Premium basketball courts and professional training in Tarakeshwar, Kathmandu. Open play, memberships, and coached sessions for all ages.', color: '#B85A00', active: true, order: 2 },
  { name: 'Pickleball', slug: 'pickleball', emoji: '🎾', tagline: "Nepal's Premier Pickleball Facility", description: "Discover the fastest-growing racket sport at Tiptoe Sports Hub. Pickleball combines tennis, badminton, and ping-pong into an exciting fast-paced game. We offer dedicated courts, professional equipment, and coaching for beginners.", facilities: "Dedicated pickleball courts\nProfessional court lighting\nEquipment rental & retail\nRefreshments corner\nSpectator seating", pricing: "Court Hire - NPR 1,200/hr (includes paddles & balls)\nMonthly Access - NPR 3,500/month\nCoaching Package - NPR 4,000/month (8 sessions)\nTournament Entry - NPR 500/event", schedule: 'Daily: 6AM-10PM | Beginner sessions: Mon, Wed 6PM-8PM', seoTitle: 'Pickleball Courts in Kathmandu | Tiptoe Sports Hub', seoDescription: "Nepal's premier pickleball facility in Tarakeshwar, Kathmandu. Beginner-friendly courts, equipment included, coaching available.", color: '#1B7F5E', active: true, order: 3 },
  { name: 'Snooker', slug: 'snooker', emoji: '🎱', tagline: 'Premium Snooker Club & Professional Tables', description: "Tiptoe Sports Hub's snooker club offers the finest billiards experience in Kathmandu. Professional-grade tables, optimal lighting, and a relaxed premium atmosphere for casual play, practice, or competitive matches.", facilities: "Multiple professional snooker tables\nDedicated tournament-grade lighting\nComfortable lounge area\nCue & equipment rack\nRefreshment service", pricing: "Table Hire - NPR 800/hr (equipment included)\nMonthly Membership - NPR 3,000/month\nVIP Membership - NPR 5,000/month (priority booking + lounge)\nDay Pass - NPR 400/day", schedule: 'Daily: 10AM-11PM | Open 7 days a week', seoTitle: 'Snooker Club in Kathmandu | Tiptoe Sports Hub', seoDescription: 'Premium snooker club with professional tables in Tarakeshwar, Kathmandu. Table hire, memberships, and VIP packages available.', color: '#2D7D46', active: true, order: 4 },
  { name: 'Sports Lounge', slug: 'sports-lounge', emoji: '📺', tagline: 'Live Sports Screening, Great Food & Relaxed Social Vibes', description: "The ultimate sports viewing and social experience at Tiptoe Sports Hub. Multiple large HD screens broadcasting live international and local sports, great food and beverages, and a relaxed family-friendly atmosphere. Watch Champions League, World Cup, or Nepal Super League.", facilities: "Multiple large HD projection screens\nComfortable lounge seating\nIndoor air-conditioned space\nOutdoor terrace area\nPrivate event space (up to 50 guests)\nLive sports satellite subscription", pricing: "Walk-In - Free entry with food or beverage order\nVIP Table (4 pax) - NPR 2,000 minimum spend\nMatch Day Package - NPR 5,000 for 10 pax (food + drinks + seating)\nPrivate Event - Contact for quote", schedule: 'Mon-Thu: 4PM-11PM | Fri-Sun: 12PM-12AM | Special event hours vary', seoTitle: 'Sports Lounge in Kathmandu | Tiptoe Sports Hub', seoDescription: "Best sports lounge in Tarakeshwar, Kathmandu. Live sports screening on big screens, great food and a relaxed social atmosphere at Tiptoe Sports Hub.", color: '#8B4A00', active: true, order: 5 },
]
...
const SEED_PRICING = [
  ...
  { sport: 'Sports Lounge', title: 'Walk-In',            price: 'Free entry', period: '',         badge: '',      features: ['With minimum drink purchase', 'Live sports on big screens', 'Full drinks & food menu'],                              active: true, order: 16 },
  { sport: 'Sports Lounge', title: 'VIP Table',          price: 'NPR 2,000', period: 'min spend', badge: 'Popular', features: ['Reserved seating for 4', 'Priority service', 'All major sports events'],                                          active: true, order: 17 },
]

const SEED_FAQ = [
  { category: 'General',    order: 1,  active: true, question: 'Where is Tiptoe Sports Hub located?',                            answer: 'Tiptoe Sports Hub is located in Tarakeshwar, Kathmandu, Nepal. We are easily accessible from Ring Road and have parking available on site.' },
  { category: 'General',    order: 2,  active: true, question: 'What sports facilities does Tiptoe Sports Hub offer?',           answer: 'We offer Football and Futsal, Cricket, Basketball, Pickleball, Snooker, and a Sports Lounge, all under one roof in Tarakeshwar, Kathmandu.' },
  { category: 'General',    order: 3,  active: true, question: 'What are your opening hours?',                                    answer: 'Mon–Fri: 6AM–9PM | Saturday: 6AM–8PM | Sunday: 7AM–12PM. Sports Lounge: Mon–Thu 4PM–11PM, Fri–Sun 12PM–12AM. Hours may vary on public holidays.' },
  ...
  { category: 'Sports Hub', order: 14, active: true, question: 'Can I host a private event at the Sports Lounge?',                  answer: 'Yes! The Sports Lounge is available for private events for up to 50 guests, with exclusive venue hire, full catering, and live sports broadcasting. Contact us for a custom quote.' },
]
