...
const FALLBACK_FAQS = [
  ...
  { id: 'q18', category: 'Sports Hub', order: 18, question: 'Can I hire the futsal court in Kathmandu?', answer: 'Yes, the futsal court at Tiptoe Sports Hub in Tarkeshwar, Kathmandu is available for hire outside of academy training hours. Contact us via WhatsApp or phone to check availability and rates for futsal court hire in Kathmandu.' },
  { id: 'q19', category: 'Sports Hub', order: 19, question: 'Is there a snooker club in Kathmandu?', answer: 'Yes — Tiptoe Sports Hub has one of the best snooker clubs in Kathmandu, located in Tarkeshwar. We offer professional-grade tables, cues and chalk included, table hire by the hour, monthly memberships, and VIP lounge access.' },
  { id: 'q20', category: 'Academy', order: 20, question: 'What youth sports programs does Tiptoe Sports Hub offer in Kathmandu?', answer: 'Tiptoe Sports Hub offers a full range of youth sports in Kathmandu: football and futsal academy (ages 4–18), girls football program (ages 8–18), basketball coaching, pickleball for beginners, and holiday camp programs. All located at our sports facility in Tarkeshwar, Kathmandu.' },
]
