...
const COACHES = [
  {
    ...
    exp: '27+ Years',
    highlights: [
      'Nepal National Futsal Team Head Coach — 3 consecutive terms',
      'Former Head Coach, Manang Marshyangdi Club (A Division)',
      'Led Nepal internationally: Iran, Kyrgyzstan, Mongolia',
      'Co-founded Tiptoe Sports Hub in 2021',
    ],
  },
  {
    name: 'Hari Khadka',
    role: 'Brand Ambassador & Technical Advisor',
    exp: '20+ Years',
    highlights: [
      "Nepal's All-Time Highest International Goal Scorer",
      'Former Captain, Nepal National Football Team',
      "Former Head Coach, National Women's Football Team",
      'Former Acting Technical Director, ANFA',
    ],
  },
]
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
              ...
              <motion.div key={c.name}
                ...
                <div className="flex items-start gap-4 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs mt-0.5">{c.exp} experience</p>
                  </div>
                </div>
          ...
          <div className="text-center mt-8">
            <Link to="/coaches" className="btn-outline text-sm">
              Meet All Coaches <FaArrowRight size={12} />
            </Link>
          </div>
        </div>
      </section>
