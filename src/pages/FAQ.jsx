...
const FALLBACK_FAQS = [
  ...
  { id: 'q17', category: 'Sports Hub', order: 17, question: 'Does the Sports Bar show live football and cricket matches?', answer: 'Yes! Tiptoe Sports Bar is Kathmandu\'s premier sports bar for live match screening. We broadcast all major football leagues (EPL, La Liga, Champions League), international cricket, NBA, and more on large screens. Match-day atmosphere is guaranteed.' },
