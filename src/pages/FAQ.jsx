...
const FALLBACK_FAQS = [
  { id: 'q1', category: 'General', order: 1, question: 'Where is Tiptoe Sports Hub located?', answer: 'Tiptoe Sports Hub is located in Tarakeshwar, Kathmandu, Nepal. We are easily accessible from Ring Road and have parking available on site.' },
  { id: 'q2', category: 'General', order: 2, question: 'What sports facilities does Tiptoe Sports Hub offer?', answer: 'We offer Football and Futsal, Cricket, Basketball, Pickleball, Snooker, and a Sports Lounge, all under one roof in Tarakeshwar, Kathmandu. Tiptoe Sports Academy (football and futsal coaching) also operates from here.' },
  { id: 'q3', category: 'General', order: 3, question: 'What are your opening hours?', answer: 'Mon–Fri: 6AM–9PM | Saturday: 6AM–8PM | Sunday: 7AM–12PM. Sports Lounge: Mon–Thu 4PM–11PM, Fri–Sun 12PM–12AM. Hours may vary on public holidays.' },
  ...
  { id: 'q15', category: 'Sports Hub', order: 15, question: 'Can I host a private event at the Sports Lounge?', answer: 'Yes! The Sports Lounge is available for private events for up to 50 guests, with exclusive venue hire, full catering, and live sports broadcasting. Contact us for a custom quote and availability.' },
  { id: 'q16', category: 'Sports Hub', order: 16, question: 'Do I need to be a member to use the Sports Lounge?', answer: 'No membership is required for the Sports Lounge. Walk-ins are welcome with a minimum drink purchase. VIP table bookings are available for groups wanting reserved seating and priority service.' },
  { id: 'q17', category: 'Sports Hub', order: 17, question: 'Does the Sports Lounge show live football and cricket matches?', answer: 'Yes! Tiptoe Sports Lounge is Kathmandu\'s premier sports bar for live match screening. We broadcast all major football leagues (EPL, La Liga, Champions League), international cricket, NBA, and more on large screens. Match-day atmosphere is guaranteed.' },
  { id: 'q18', category: 'Sports Hub', order: 18, question: 'Can I hire the futsal court in Kathmandu?', answer: 'Yes, the futsal court at Tiptoe Sports Hub in Tarakeshwar, Kathmandu is available for hire outside of academy training hours. Contact us via WhatsApp or phone to check availability and rates for futsal court hire in Kathmandu.' },
  { id: 'q19', category: 'Sports Hub', order: 19, question: 'Is there a snooker club in Kathmandu?', answer: 'Yes — Tiptoe Sports Hub has one of the best snooker clubs in Kathmandu, located in Tarakeshwar. We offer professional-grade tables, cues and chalk included, table hire by the hour, monthly memberships, and VIP lounge access.' },
  { id: 'q20', category: 'Academy', order: 20, question: 'What youth sports programs does Tiptoe Sports Hub offer in Kathmandu?', answer: 'Tiptoe Sports Hub offers a full range of youth sports in Kathmandu: football and futsal academy (ages 4–18), girls football program (ages 8–18), basketball coaching, pickleball for beginners, and holiday camp programs. All located at our sports facility in Tarakeshwar, Kathmandu.' },
  { id: 'q21', category: 'Sports Hub', order: 21, question: 'Can I hire a basketball court in Kathmandu?', answer: 'Yes! Tiptoe Sports Hub has a full-size basketball court in Tarakeshwar, Kathmandu available for hire by the hour (NPR 1,500/hr). Walk-ins are welcome and a ball is included. Monthly memberships with unlimited court access are also available at NPR 4,000/month. Coached sessions run Tuesday, Thursday and Saturday evenings.' },
  { id: 'q22', category: 'Sports Hub', order: 22, question: 'Is there a pickleball court in Kathmandu?', answer: 'Yes — Tiptoe Sports Hub has dedicated pickleball courts in Tarakeshwar, Kathmandu, making it one of the very few venues in Nepal offering this sport. Courts are available for hire (NPR 1,200/hr, paddles and balls included), and we run beginner coaching sessions weekly. Monthly access passes are also available.' },
]
